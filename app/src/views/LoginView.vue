            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" @submit.prevent="handleClickLogin">
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" name="email" v-model="form.email" type="email" autocomplete="email" required
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember-me" name="remember-me" v-model="form.remember_me" type="checkbox"
...
import { login } from '@/composables/auth/auth_service'
