  ...
  <div class="py-10">
    <header>
      <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        ...
        <el-button type="primary" @click="handleCLickCreateUser" round>Create User</el-button>
      </div>
    </header>
    <main>
        ...
        <div class="px-4 py-8 sm:px-0">
          <div class="border-4 p-2 border-dashed border-gray-200 rounded-lg h-96">
            <el-table v-loading="loadingUsers" :data="users" style="width: 100%">
              ...
              <el-table-column prop="email" label="Name" />
              <el-table-column prop="role.name" label="Role" />
              <el-table-column fixed="right" label="Actions">
                <template #default="scope">
                  <el-button type="success" @click="handleClickEdit(scope.row.id)" size="small">Edit</el-button>
                  <el-button type="danger" v-if="profile.role.name.toLowerCase() == 'admin'" size="small" @click="handleClickDelete(scope.row.id, scope.$index)">Delete
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
